"""
Django settings for woodywood project.
...
SECRET_KEY = 'django-insecure-^(7c^guw+oy)ogse9bfhe2x3-_*88d@3!)id9^lbuxpy)7p1cx'
...
WSGI_APPLICATION = 'woodywood.wsgi.application'
...
STATIC_URL = 'woodywood/frontend/static/'
